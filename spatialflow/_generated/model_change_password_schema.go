...
func (o *ChangePasswordSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varChangePasswordSchema := _ChangePasswordSchema{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varChangePasswordSchema)

	if err != nil {
		return err
	}

	*o = ChangePasswordSchema(varChangePasswordSchema)
