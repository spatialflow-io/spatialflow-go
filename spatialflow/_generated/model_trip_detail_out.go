...
// checks if the TripDetailOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TripDetailOut{}

// TripDetailOut struct for TripDetailOut
type TripDetailOut struct {
	Id string `json:"id"`
	...
	PlannedRouteGeojson map[string]interface{} `json:"planned_route_geojson,omitempty"`
	TrackGeometryGeojson map[string]interface{} `json:"track_geometry_geojson,omitempty"`
}

type _TripDetailOut TripDetailOut
...
func (o *TripDetailOut) SetStartTimeNil() {
	o.StartTime.Set(nil)
}
...
func (o *TripDetailOut) SetEndTimeNil() {
	o.EndTime.Set(nil)
}
...
func (o *TripDetailOut) SetDurationSecondsNil() {
...
func (o *TripDetailOut) SetDistanceMetersNil() {
...
func (o *TripDetailOut) SetSessionIdNil() {
	o.SessionId.Set(nil)
}
...
// GetPlannedRouteGeojson returns the PlannedRouteGeojson field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TripDetailOut) GetPlannedRouteGeojson() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
	return o.PlannedRouteGeojson
}

// GetPlannedRouteGeojsonOk returns a tuple with the PlannedRouteGeojson field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TripDetailOut) GetPlannedRouteGeojsonOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.PlannedRouteGeojson) {
		return map[string]interface{}{}, false
	}
	return o.PlannedRouteGeojson, true
}
...
// SetPlannedRouteGeojson gets a reference to the given map[string]interface{} and assigns it to the PlannedRouteGeojson field.
func (o *TripDetailOut) SetPlannedRouteGeojson(v map[string]interface{}) {
	o.PlannedRouteGeojson = v
}

// GetTrackGeometryGeojson returns the TrackGeometryGeojson field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TripDetailOut) GetTrackGeometryGeojson() map[string]interface{} {
	if o == nil {
		var ret map[string]interface{}
		return ret
	}
	return o.TrackGeometryGeojson
}

// GetTrackGeometryGeojsonOk returns a tuple with the TrackGeometryGeojson field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TripDetailOut) GetTrackGeometryGeojsonOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.TrackGeometryGeojson) {
		return map[string]interface{}{}, false
	}
	return o.TrackGeometryGeojson, true
}
...
// SetTrackGeometryGeojson gets a reference to the given map[string]interface{} and assigns it to the TrackGeometryGeojson field.
func (o *TripDetailOut) SetTrackGeometryGeojson(v map[string]interface{}) {
	o.TrackGeometryGeojson = v
}

func (o TripDetailOut) MarshalJSON() ([]byte, error) {
...
func (o TripDetailOut) ToMap() (map[string]interface{}, error) {
	...
	if o.PlannedRouteGeojson != nil {
		toSerialize["planned_route_geojson"] = o.PlannedRouteGeojson
	}
	if o.TrackGeometryGeojson != nil {
		toSerialize["track_geometry_geojson"] = o.TrackGeometryGeojson
	}
	return toSerialize, nil
}

func (o *TripDetailOut) UnmarshalJSON(data []byte) (err error) {
	...
	varTripDetailOut := _TripDetailOut{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTripDetailOut)

	if err != nil {
		return err
	}

	*o = TripDetailOut(varTripDetailOut)

	return err
}

type NullableTripDetailOut struct {
	value *TripDetailOut
	isSet bool
}

func (v NullableTripDetailOut) Get() *TripDetailOut {
	return v.value
}

func (v *NullableTripDetailOut) Set(val *TripDetailOut) {
	v.value = val
	v.isSet = true
}

func (v NullableTripDetailOut) IsSet() bool {
	return v.isSet
}

func (v *NullableTripDetailOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTripDetailOut(val *TripDetailOut) *NullableTripDetailOut {
	return &NullableTripDetailOut{value: val, isSet: true}
}

func (v NullableTripDetailOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTripDetailOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
